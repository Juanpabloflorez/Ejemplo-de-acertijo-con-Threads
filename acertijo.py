...
class Mainview(tk.Frame):
    def __init__(self, parent, controller=None):
        ...
        if pais == 1:
            ...
            self.imagen1 = tk.PhotoImage(file = "map.png")
            ...
            self.imagen2 = tk.PhotoImage(file="map2.png")
        ...
        def guerraeurasia():
            ...
            self.imagen2 = tk.PhotoImage(file="image2.png")
            self.imagen2_sub = self.imagen2.subsample(2, 2)
            self.map2 = tk.Label(self, image=self.imagen2_sub)
        ...
        def guerraanarquia():
            ...
            self.imagen2 = tk.PhotoImage(file="image.png")
            self.imagen2_sub = self.imagen2.subsample(2, 2)
            self.map2 = tk.Label(self, image=self.imagen2_sub)
            self.map2.place(x=150, y=590)
